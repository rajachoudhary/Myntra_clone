...
export const BottomFooter = () => {
  return (
    <div className={style.landingFooter}>
        ...
        <div>
            <div className={style.landingPAgetext}>
                <div className={style.footerHeading}>EXPERIENCE MYNTRA APP ON MOBILE</div>
                <div className={style.footerPlayStoreimages}>
                    <div>
                        <img  src="https://constant.myntassets.com/web/assets/img/80cc455a-92d2-4b5c-a038-7da0d92af33f1539674178924-google_play.png" alt="PlayStore" />
                    </div>
                    <div>
            ...
            <div className={style.footerSocialMediaLogoContainer}>
                ...
                <div className={style.footerSocialMediaLogo}>
                    <img src="https://constant.myntassets.com/web/assets/img/a7e3c86e-566a-44a6-a733-179389dd87111574604275355-yt.png" alt="You tube" />
                </div>
                <div className={style.footerSocialMediaLogo}>
        ...
        <div className={style.footerRightLogo}>
            <div className={style.footerOriginalLogo}>
                <img  src="https://constant.myntassets.com/web/assets/img/b4fcca19-5fc1-4199-93ca-4cae3210ef7f1574604275408-insta.png" alt="instagram" />
                <div ><span className={style.footerBoldText}>100% ORIGINAL </span>guarantee for all products at myntra.com </div>
            </div>
            <div className={style.footerThirtyLogo}>
                <img src="https://constant.myntassets.com/web/assets/img/ef05d6ec-950a-4d01-bbfa-e8e5af80ffe31574602902427-30days.png" alt="instagram" />
                <div><span className={style.footerBoldText}>Return within 30days </span>of receiving your order</div>
            </div>
        </div>
    </div>
  )
